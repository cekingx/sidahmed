...
var sizes = __webpack_require__(198);

var MobileDetect = __webpack_require__(143);
var md = new MobileDetect(window.navigator.userAgent);

var siteUrl = $("meta[name='root-url']").attr("content");
...
window.editor = {
	...
	settings: {
		...
		colorData: {
			selected: "poster",
			colors: [{ type: "poster", color: "#000000" }, { type: "map", color: "#000000" }, { type: "text", color: "#ffffff" }, { type: "borders", color: "#ffffff" }]
		},
	...
	events: {
		...
		onComponentColorChange: function onComponentColorChange() {},
		...
		onCustomMessageChange: function onCustomMessageChange() {},

		onDesignChange: function onDesignChange() {}
	},
	...
	methods: {
		...
		updateBorders: function updateBorders() {
			var elm = $("#canvas-border");
		...
		updateComponentColors: function updateComponentColors() {
		...
		updateMapDesign: function updateMapDesign() {
			// Loading screen
			$('#canvas-map').hide();
			$('#canvas-overlay').show();
		...
		exportImage: function exportImage() {
			...
			var _canvasWrapper = $("#canvas-map");
			var _canvas = _canvasWrapper.find("canvas");
			var _image = _canvas[0].toDataURL('image/png', 1.0);
		...
		exportPDF: function exportPDF(onComplete) {
			...
			var _canvasWrapper = $("#canvas-wrapper");
			var _canvas = _canvasWrapper.find("canvas");
			var _image = _canvas[0].toDataURL('image/png', 1.0);
		...
		resetCanvasForm: function resetCanvasForm() {
...
var $img = $('<img src="' + siteUrl + 'img/editor/heart.png" class="heart" id="heartImage"/>').on('load', function () {
	var img = this;
...
$(function () {
	...
	$('#customize_borderSize').range({
		...
		onChange: function onChange(value, meta) {
...
$(function () {
	...
	// Init color picker
	ColorPicker(document.getElementById('theme_picker'), function (hex, hsv, rgb) {
...
$(function () {
	...
	$("#finish_size").dropdown({
		...
		onChange: function onChange(value, txt, $itm) {
