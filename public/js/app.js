...
window.siteUrl = $("meta[name='root-url']").attr("content");
...
/**
 * Now we will find the root URL of the website to generate some helpers in Vue files.
 * This will be determined by the environment file of the Laravel application.
 **/

var rootUrl = document.head.querySelector('meta[name="root-url"]');

if (rootUrl) {
  window.root = rootUrl.content;
} else {
  console.error('root not found: add a "root-url" URL meta tag in the HTML document');
  window.root = '';
}
